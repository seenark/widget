...
export const OrganizationSelectView: FC<Props> = ({ redirect }) => {
  ...
  const handleSubmit = useCallback(
    ...
    [name, createOrganization, redirect, nav]
  );
    ...
    <div className="flex items-center justify-center rounded-4xl bg-[#1e1e2e] px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              className="group relative flex w-full cursor-pointer justify-center rounded-md border border-transparent bg-[#89b4fa] px-4 py-2 font-medium text-[#1e1e2e] text-sm hover:bg-[#74c7ec] focus:outline-none focus:ring-2 focus:ring-[#89b4fa] focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
